...
{
    public sealed class RemoveConversationMemberHandler : ICommandHandler<RemoveConversationMemberCommand>
    {
        private readonly IConversationRepository _repo;
        private readonly IOutboxStore _outbox;

        public RemoveConversationMemberHandler(IConversationRepository repo, IOutboxStore outbox)
        {
            _repo = repo;
            _outbox = outbox;
        }
        ...
        public async Task<Unit> Handle(RemoveConversationMemberCommand cmd, CancellationToken cancellationToken)
        {
            // 1. Validation
            ...
            Guard.AgainstNull(cmd.MemberUserIdsToRemove, nameof(cmd.MemberUserIdsToRemove));
            ...
            // 3. Call Domain Logic
            conv.RemoveMember(cmd.ActorUserId, cmd.MemberUserIdsToRemove);
